...
void Billiards::addBall(hkReal x, hkReal y, hkReal z)
{
	Ball* ball = new Ball();
...
void Billiards::setPosOfBall(hkReal x, hkReal y, hkReal z, int number)
{
...
hkVector4 Billiards::getPosOfBall(int number)
{
	assert(number < (int)m_ballList.size());
...
hkQuaternion Billiards::getgetRotationOfBall(int number)
{
	assert(number < (int)m_ballList.size());
...
void Billiards::deleteBall(int number)
{
	assert(number < (int)m_ballList.size());
